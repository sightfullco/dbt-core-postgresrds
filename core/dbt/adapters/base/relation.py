...
class BaseRelation(FakeAPIObject, Hashable):
    ...
    renameable_relations: SerializableIterable = field(default_factory=lambda: SerializableIterable())
    ...
    replaceable_relations: SerializableIterable = field(default_factory=lambda: SerializableIterable())
